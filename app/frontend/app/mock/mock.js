    ...
    app.run(function ($httpBackend) {
        ...
        $httpBackend.whenGET('/private/api/userslist').respond(function (method, url, data) {
            ...
            var friends = [
                ...
                {name: "Homer", surname: "Mueller", profile: "/static/app/resources/friends/131.jpg", online: true, socket: "gmP4ZvJpaWpRNeq01OAR"},
                {name: "Louis", surname: "Mueller", profile: "/static/app/resources/friends/131.jpg", online: true, socket: "gmP4ZvJpaWpRNeq01OAR"},
                {name: "Jack", surname: "Mueller", profile: "/static/app/resources/friends/131.jpg", online: true, socket: "gmP4ZvJpaWpRNeq01OAR"}
            ];
            return [200, friends];
        });
